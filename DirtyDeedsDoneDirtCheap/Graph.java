            ...
            if ( sourceVertex.vertexInfo.compareTo( source ) == 0 ){
                ...
                while (destinationVertex!=null){
                    if ( destinationVertex.vertexInfo.compareTo( destination ) == 0 ){
                        ...
                        Edge<T,N> newEdgeOne = new Edge<T, N>(sourceVertex, destinationVertex, w, sourceVertex.firstEdge);
                        Edge<T,N> newEdgeTwo = new Edge<T, N>(destinationVertex, sourceVertex, w, destinationVertex.firstEdge);
