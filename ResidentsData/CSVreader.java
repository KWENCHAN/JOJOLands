...
public class CSVreader {
    ...
    public static ArrayList<Resident> readResident(String location) {
        try {
            Scanner in = new Scanner(new FileInputStream("C:\\HON YAO ZHI\\Data Structure\\AssignmentJojo_submitgit\\src\\ResidentsData\\residents.csv"));
    ...
    private static Stand readStand(String name) {
        try {
            Scanner in = new Scanner(new FileInputStream("C:\\HON YAO ZHI\\Data Structure\\AssignmentJojo_submitgit\\src\\ResidentsData\\stands.csv"));
            while (in.hasNextLine()) {
                String next = in.nextLine();
