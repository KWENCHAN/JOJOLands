...
public class CSVreader {
    ...
    public static ArrayList<Resident> readResident(String location) {
        try {
            Scanner in = new Scanner(new FileInputStream("C:\\Users\\chank\\OneDrive\\Documents\\UM\\SEM 2\\WIA1002 DATA STRUCTURE\\JOJOLandsMaster\\ResidentsData\\residents.csv"));
    ...
    private static Stand readStand(String name) {
        try {
            Scanner in = new Scanner(new FileInputStream("C:\\Users\\chank\\OneDrive\\Documents\\UM\\SEM 2\\WIA1002 DATA STRUCTURE\\JOJOLandsMaster\\ResidentsData\\stands.csv"));
            while (in.hasNextLine()) {
                String next = in.nextLine();
